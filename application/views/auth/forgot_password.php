                        ...
                        <div class="col-md-4">
                            <div class="box">
                                <div class="form-box">
                                    ...
                                    <?php echo form_open(base_url('forgot-password'), ['id' => 'commentform-footer', 'class' => 'comment-form', 'nonvalidate' => '"']);?>
                                        <fieldset class="style name-container">
                                            <label>Your Email Address</label>
                                            <input type="text" id="author-footer" class="tb-my-input" name="identity" tabindex="1" value="" size="32" aria-required="true">
                                        </fieldset>
