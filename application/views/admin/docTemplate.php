<div class="header">
    <h1 class="page-header">
        Excel Template <a href="" ng-click="newDocTemplate()" ng-show="showform != true"><i class="fa fa-plus" aria-hidden="true"></i></a>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-10">
                            <form class="form-horizontal" method="POST" ng-submit="addDocTemplate()">
                                <div class="form-group">
                                    <label for="" class="control-label col-lg-2">name</label>
                                    <div class="col-lg-6">
                                        <input type="text" name="name" class="form-control" ng-model="newtemplate.name"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <button ngf-select="uploadFiles($files, $invalidFiles)"
                                                accept=".csv, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/vnd.ms-excel,text/plain,application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint,application/vnd.oasis.opendocument.text,.ods"
                                                ngf-max-size="15MB"
                                                ngf-multiple="false"
                                                type="button">
                                            Select Files
                ...
                <div class="table-responsive">
                    <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            ...
                            <tbody>
                            <tr dir-paginate="template in templates | filter:search | limitTo:pageSize | itemsPerPage:numPerPage">
                                <td>{{$index+1}}</td>
                                <td>{{template.name}}</td>
                                <td><a href="{{base_url + 'files/' + template.file.file_name}}">{{template.file.file_name}}</a></td>
                                <td>
                                    <div  class="btn-group btn-group-xs" role="group" ng-if="template.active == 1">
                                            <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle">Available<span class="caret"></span></button>
                                            <ul class="dropdown-menu">
                                                <li><a confirmed-click="disableDocTemplate(template)" ng-confirm-click="Would you like to disable this item?!">De-activate</a></li>
                                            </ul>
                                    </div>
                                    <div  class="btn-group btn-group-xs" role="group"  ng-if="template.active == 0">
                                        <button data-toggle="dropdown" class="btn btn-danger dropdown-toggle">Disable<span class="caret"></span></button>
                                        <ul class="dropdown-menu">
                                            <li><a confirmed-click="enableDocTemplate(template)" ng-confirm-click="Would you like to enable this item?!">Activate</a></li>
                                        </ul>
                                    </div>
                                </td>
                                <td>
                                    <div  class="btn-group btn-group-xs" role="group">
                                        <button type="button" class="btn btn-info" ng-click="editDocTemplate(template)">
                                            <i class="fa fa-pencil"></i>
                                        </button>
                                        <button  type="button" class="btn btn-danger" confirmed-click="deleteDocTemplate(template)" ng-confirm-click="Would you like to delete this item?!">
