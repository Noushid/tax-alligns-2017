                        ...
                        <div>
                            <ul class="list-group">
                                <uib-accordion close-others="true">
                                    ...
                                    <li class="list-group-item" dir-paginate="message in messages | filter:search | limitTo:pageSize | itemsPerPage:numPerPage">
                                        <div uib-accordion-group heading="{{message.message}}">
                                            <span> {{message.message}}</span>
                                            <a href="{{base_url + 'uploads/' + message.file.file_name}}"> <img src="{{base_url + 'adm/assets/img/pdf_icon.png'}}" alt="" width="25"/></a>
                                        </div>
                                    </li>
                                </uib-accordion>
                            </ul>
